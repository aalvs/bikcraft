...
// Mudar Aqui o e-mail
$email_envio = "contato@bikcraft.com.br"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "bikcraft123"; // Senha do e-mail

$site_name = "Bikcraft"; // Nome do Site
$site_url = "www.bikcraft.com"; // URL do Site

$host_smtp = "smtp.bikcraft.com.br"; // HOST SMTP Ex: smtp.domain.com.br
